...
public class EmbarcacaoDePequenoPorte extends Embarcacao {
    ...
    public EmbarcacaoDePequenoPorte(String m, String mod, String c, String i, 
            double n, int v, double p, double a, String t, int pot) {
        super(m, mod, c, i, n, v, p, a);
        setTipoDeCasco(t);
        setPotenciaDoMotor(pot);
    }
    ...
    public void imprimir() {
        super.imprimir();
        System.out.print("\nTipo de Casco da Embarcação de Pequeno Porte: " 
                + getTipoDeCasco());
        System.out.print("\nPotência do Motor da Embarcação de Pequeno Porte: " 
                + getPotenciaDoMotor() + " hp.");
    }

    public void cadastrar(String m, String mod, String c, String i, double n, 
            int v, double p, double a, String t, int pot) {
