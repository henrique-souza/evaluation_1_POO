...
public class Embarcacao {
    ...
    public Embarcacao(String m, String mod, String c, String i, double n, 
            int v, double p, double a) {
        setMarca(m);
        setModelo(mod);
        setCor(c);
        setIdentificacao(i);
    ...
    public void cadastrar(String m, String mod, String c, String i, 
            double n, int v, double p, double a) {
        setMarca(m);
        setModelo(mod);
        setCor(c);
        setIdentificacao(i);
    ...
    public void imprimir() {
        ...
        System.out.print("\nIdentificação da Embarcação: " 
                + getIdentificacao());
        System.out.printf("\nNúmero de Passageiros da Embarcação: " 
                + getNumeroDePassageiros() + " passsageiros.");
        System.out.print("\nVelocidade Máxima da Embarcação: " 
                + getVelocidadeMaxima() + " Km/h");
        System.out.print("\nPreço da Embarcação - R$ " + getPreco());
        System.out.print("\nAltura do Calado da Embarcação: " 
                + getAlturaDoCalado() + " m");
    }
}
