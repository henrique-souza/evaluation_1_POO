...
public class Iate extends Embarcacao {
    ...
    public void entradaDeDados() {
        ...
        setNumeroDeTripulantes(Integer.parseInt(entradaDoDado.nextLine()));
        System.out.printf("\nQuantas cabines o Iate tem? ");
        setNumeroDeCabines(Double.parseDouble(entradaDoDado.nextLine()));
        System.out.print("\nDigite o peso do Iate: ");
        setPeso(Double.parseDouble(entradaDoDado.nextLine()));
        System.out.print("\nExiste Piscina no Iate? 1 - Sim / 2 - Não : ");
        int escolha_do_usuario = Integer.parseInt(entradaDoDado.nextLine());
    ...
    public void imprimir() {
        ...
        System.out.printf(
                new DecimalFormat(
                        "\nNúmero de pessoas por cabine dentro Iate: 0.0")
                        .format(pessoasPorCabine()) + " pessoas.\n\n");
    }
